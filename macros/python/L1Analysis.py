...
class L1Ana(object):
    ...
    def init_l1_analysis():
        ...
        root.gSystem.AddIncludePath(
            " -I$CMSSW_BASE/src/L1TriggerDPG/L1Ntuples/interface")
        root.gSystem.AddIncludePath(
            " -I$CMSSW_BASE/src/L1TriggerDPG/L1Ntuples/macros")
        root.gROOT.ProcessLine(
            ".include $CMSSW_BASE/src/L1TriggerDPG/L1Ntuples/interface")
        root.gROOT.ProcessLine(
            ".include $CMSSW_BASE/src/L1TriggerDPG/L1Ntuples/macros")

        root.gSystem.AddIncludePath(
            " -I$CMSSW_BASE/src/L1TriggerDPG/L1Ntuples/macros/L1Rates")
        root.gSystem.AddIncludePath(
            " -I$CMSSW_BASE/src/L1TriggerDPG/L1Ntuples/macros/L1Rates/toolbox")
        root.gROOT.ProcessLine(
            ".include $CMSSW_BASE/src/L1TriggerDPG/L1Ntuples/macros/L1Rates")
        root.gROOT.ProcessLine(
            ".include $CMSSW_BASE/src/L1TriggerDPG/L1Ntuples/macros/L1Rates/toolbox")
...
class L1Ntuple(object):
    ...
    def open_no_init(self):
        ...
        self.tree_muonupgrade = root.TChain(
            "l1MuonUpgradeTreeProducer/L1MuonUpgradeTree")
    ...
    def init_branches(self):
        ...
        self.tree_main.SetBranchAddress(
            "Event", root.AddressOf(self.data.event))
